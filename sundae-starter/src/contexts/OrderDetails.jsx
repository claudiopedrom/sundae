...
export function OrderDetailsProvider(props) {
  ...
  // itemName might be "Chocolate", "Vanilla", etc.
  // newItemCount might be 1, 2, etc.
  // optionType might be "scoops" or "toppings"
